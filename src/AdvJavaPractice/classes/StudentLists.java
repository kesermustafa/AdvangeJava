...
public class StudentLists {
    ...
    */
    ...
    public static void listGrade(){
            ...
            Student<String, Double, Double> std1 = new Student<>("Beyza", 76.8, 80.0);
            Student<String, Double, Double> std2 = new Student<>("Fred", 76.8, 80.0);
            Student<String, Double, Double> std3 = new Student<>("Wilma", 76.8, 80.0);

        System.out.printf("%-10s || %3.2f  || %-4.2f  %n", std1.getS(), std1.getU(), std1.getV());
        System.out.printf("%-10s || %3.2f  || %-4.2f  %n", std2.getS(), std2.getU(), std2.getV());
        System.out.printf("%-10s || %3.2f  || %-4.2f  %n", std3.getS(), std3.getU(), std3.getV());
        ...
        public static void listMemberLibrary(){
            ...
            Student<String, Integer, String> std2 = new Student<>("Bambam", 568, "bmbam@gmail.com");
            Student<String, Integer, String> std3 = new Student<>("Baty", 569, "baty@gmail.com");
